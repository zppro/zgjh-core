...
@property (assign, nonatomic) id <BZGFormFieldDelegate> delegate;
@property (retain, nonatomic) UITextField *textField;
@property (retain, nonatomic) UIButton *leftIndicator;
 ...
 */
@property (retain, nonatomic) UIColor *leftIndicatorInvalidColor;

/**
 The color of the left indicator when the form is valid.
 */
@property (retain, nonatomic) UIColor *leftIndicatorValidColor;

/**
 The color of the left indicator when the form is neither invalid nor valid.
 */
@property (retain, nonatomic) UIColor *leftIndicatorNoneColor;
