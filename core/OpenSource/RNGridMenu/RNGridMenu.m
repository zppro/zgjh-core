...
@property (nonatomic, retain) RNMenuItemView *selectedItemView;
...
- (instancetype)initWithItems:(NSArray *)items {
    if ((self = [super init])) {
        ...
        self.itemFont = [UIFont boldSystemFontOfSize:14.f];
        self.highlightColor = [UIColor colorWithRed:.02f green:.549f blue:.961f alpha:1.f];
        _menuStyle = RNGridMenuStyleGrid;
        _itemTextAlignment = NSTextAlignmentCenter;
        _menuView = [[UIView new] retain];
...
- (void)showAnimated:(BOOL)animated {
    ...
    _blurView = [[UIView alloc] initWithFrame:self.parentViewController.view.bounds];
