...
@property (nonatomic, assign) id<RNGridMenuDelegate> delegate;
...
@property (nonatomic, retain) UIBezierPath *backgroundPath;
...
@property (nonatomic, retain) UIBezierPath *blurExclusionPath;
