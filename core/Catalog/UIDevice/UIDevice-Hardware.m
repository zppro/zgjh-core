...
- (NSUInteger) platformType
{
    ...
    // iPod
    if ([platform hasPrefix:@"iPod1,1"])             return UIDevice1GiPod;
    if ([platform hasPrefix:@"iPod2,1"])              return UIDevice2GiPod;
    if ([platform hasPrefix:@"iPod3,1"])              return UIDevice3GiPod;
    if ([platform hasPrefix:@"iPod4,1"])              return UIDevice4GiPod;
